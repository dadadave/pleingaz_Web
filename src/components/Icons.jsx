...
export const Social = ({ name }) => {
  const paths = {
    ...
    tiktok: <path d="M16.5 3c.3 2.1 1.5 3.6 3.5 3.9v2.6c-1.3.1-2.5-.3-3.6-1v5.6c0 3.2-2.4 5.4-5.3 5.4-2.7 0-4.8-2-4.8-4.7 0-2.9 2.4-4.9 5.5-4.5v2.7c-.4-.1-.9-.2-1.3-.1-1.1.1-1.9.9-1.9 2 0 1.2.9 2 2 2 1.2 0 2.1-.9 2.1-2.4V3Z" />,
  };
  if (name === 'instagram') {
    return (
